...
def setChecker(card1 : Card, card2 : Card, card3 : Card):
    ...
    if(colorCheck(c1Color,c2Color,c3Color) and fillCheck(c1Fill,c2Fill,c3Fill) and shapeCheck(c1Shape,c2Shape,c3Shape) and countCheck(c1Number,c2Number,c3Number)):
        return True
